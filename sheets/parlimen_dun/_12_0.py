...
ROW_MAP = {
    11: ("pertanian_perhutanan_perikanan", "2025"),
    14: ("tanaman", "2025"),
    17: ("ternakan", "2025"),
    20: ("perikanan", "2025"),
    23: ("perhutanan_pembalakan", "2025"),
...
def populate_jadual_12(sheet, hierarchy, report_type):
    ...
    title_bm = f": Bilangan pertubuhan/ syarikat perniagaan mengikut sektor, {loc_string_bm}, {hierarchy.get('state_name')}, 2022 - 2024"
    title_en = f": Number of organizations/companies by sector, {loc_string_en}, {hierarchy.get('state_name')}, 2022 - 2024"
