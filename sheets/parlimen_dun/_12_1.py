...
def populate_jadual_12_1(sheet, hierarchy, report_type):
    ...
    title_bm = f": Bilangan pertubuhan/ syarikat perniagaan sektor perkhidmatan terpilih, {loc_string_bm}, {hierarchy.get('state_name')}, 2022 - 2024"
    title_en = f": Number of selected establishments/ businesses in the services sector, {loc_string_en}, {hierarchy.get('state_name')}, 2022 - 2024"
