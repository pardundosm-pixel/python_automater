...
def populate_jadual_10(sheet, hierarchy, report_type):
    ...
    title_bm = f": Statistik internet dan media sosial, {loc_string_bm}, {hierarchy.get('state_name')}, 2022 - 2024"
    title_en = f": Statistics of internet and social media, {loc_string_en}, {hierarchy.get('state_name')}, 2022 - 2024"
