...
def populate_jadual_1(sheet, hierarchy, report_type):
    ...
    # 2. Build the Data Payload Sequence (MISSING LOGIC RESTORED HERE)
    locations_to_inject = []
    ...
    # Method B: Dynamic coordinates based on Target Row
    # sheet.range((target_row - 2, 3)).value = title_bm
