...
def populate_jadual_12_2(sheet, hierarchy, report_type):
    ...
    title_bm = f": Statistik kemudahan perkhidmatan, {loc_string_bm}, {hierarchy.get('state_name')}, 2022 - 2024"
    title_en = f": Statistics of service facilities, {loc_string_en}, {hierarchy.get('state_name')}, 2022 - 2024"
