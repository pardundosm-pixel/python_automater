...
def populate_jadual_11(sheet, hierarchy, report_type):
    ...
    title_bm = f": Akses kepada kemudahan asas kepada isi rumah, {loc_string_bm}, {hierarchy.get('state_name')}, 2022 - 2024"
    title_en = f": Access to basic amenities for households, {loc_string_en}, {hierarchy.get('state_name')}, 2022 - 2024"
