...
def populate_jadual_8_2(sheet, hierarchy, report_type):
    ...
    title_bm = f": Statistik kemiskinan berdaftar dengan eKasih mengikut agama ketua isi rumah, {loc_string_bm}, {hierarchy.get('state_name')}, 2022 - 2024"
    title_en = f": Statistics of poverty registered with eKasih by religion of head of household, {loc_string_en}, {hierarchy.get('state_name')}, 2022 - 2024"
