...
ROW_MAP = {
    10: ("jumlah_keseluruhan_umur", "2024"),
    11: ("jumlah_keseluruhan_umur", "2025"),
    13: ("jumlah_keseluruhan_miskin_tegar", "2024"),
    14: ("jumlah_keseluruhan_miskin_tegar", "2025"),
    16: ("jumlah_miskin_tegar_0_14", "2024"),
    17: ("jumlah_miskin_tegar_0_14", "2025"),
    19: ("jumlah_miskin_tegar_15_30", "2024"),
    20: ("jumlah_miskin_tegar_15_30", "2025"),
    22: ("jumlah_miskin_tegar_31_59", "2024"),
    23: ("jumlah_miskin_tegar_31_59", "2025"),
    25: ("jumlah_miskin_tegar_60_atas", "2024"),
    26: ("jumlah_miskin_tegar_60_atas", "2025"),
    28: ("jumlah_keseluruhan_umur_miskin", "2024"),
    29: ("jumlah_keseluruhan_umur_miskin", "2025"),
    31: ("jumlah_miskin_0_14", "2024"),
    32: ("jumlah_miskin_0_14", "2025"),
    34: ("jumlah_miskin_15_30", "2024"),
    35: ("jumlah_miskin_15_30", "2025"),
    37: ("jumlah_miskin_31_59", "2024"),
    38: ("jumlah_miskin_31_59", "2025"),
    40: ("jumlah_miskin_60_atas", "2024"),
    41: ("jumlah_miskin_60_atas", "2025"),
}
...
def populate_jadual_8_3(sheet, hierarchy, report_type):
    ...
    title_bm = f": Statistik kemiskinan berdaftar dengan eKasih mengikut kumpulan umur ketua isi rumah, {loc_string_bm}, {hierarchy.get('state_name')}, 2022 - 2024"
    title_en = f": Statistics of poverty registered with eKasih by age group of head of household, {loc_string_en}, {hierarchy.get('state_name')}, 2022 - 2024"
