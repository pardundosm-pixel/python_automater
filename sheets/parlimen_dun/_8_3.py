...
def populate_jadual_8_3(sheet, hierarchy, report_type):
    ...
    title_bm = f": Statistik kemiskinan berdaftar dengan eKasih mengikut kumpulan umur ketua isi rumah, {loc_string_bm},"
    title_en = f": Statistics of poverty registered with eKasih by age group of head of household, {loc_string_en},"
