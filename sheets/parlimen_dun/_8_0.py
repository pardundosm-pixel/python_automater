...
def populate_jadual_8(sheet, hierarchy, report_type):
    ...
    title_bm = f": Statistik kemiskinan berdaftar dengan eKasih mengikut jantina ketua isi rumah, {loc_string_bm}, {hierarchy.get('state_name')}, 2022 - 2024"
    title_en = f": Statistics of poverty registered with eKasih by sex of head of household, {loc_string_en}, {hierarchy.get('state_name')}, 2022 - 2024"
