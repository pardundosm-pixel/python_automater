...
def populate_jadual_8(sheet, hierarchy, report_type):
    ...
    title_bm = f": Statistik kemiskinan berdaftar dengan eKasih mengikut jantina ketua isi rumah, {loc_string_bm},"
    title_en = f": Statistics of poverty registered with eKasih by sex of head of household, {loc_string_en},"
    ...
    sheet.range("C3").value = title_bm_2
    sheet.range("C5").value = title_en_2
