...
# ==========================================
# MAPPING CONFIGURATION FOR JADUAL 14.2 (NEGERI)
# ==========================================
...
def populate_jadual_14_2(sheet, hierarchy):
    print(f"  -> Populating Jadual 14.2 (Penduduk Negeri) for {hierarchy['state_name']}")
