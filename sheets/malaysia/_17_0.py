...
# ==========================================
# MAPPING CONFIGURATION FOR JADUAL 17.0 (NEGERI)
# ==========================================
...
def populate_jadual_17_0(sheet, hierarchy):
    print(f"  -> Populating Jadual 17.0 (Penduduk Negeri) for {hierarchy['state_name']}")
