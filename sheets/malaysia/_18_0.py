...
# ==========================================
# MAPPING CONFIGURATION FOR JADUAL 18.0 (NEGERI)
# ==========================================
...
def populate_jadual_18_0(sheet, hierarchy):
    print(f"  -> Populating Jadual 18.0 (Penduduk Negeri) for {hierarchy['state_name']}")
