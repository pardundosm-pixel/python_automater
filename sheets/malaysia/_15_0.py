...
# ==========================================
# MAPPING CONFIGURATION FOR JADUAL 15.0 (NEGERI)
# ==========================================
...
def populate_jadual_15_0(sheet, hierarchy):
    print(f"  -> Populating Jadual 15.0 (Penduduk Negeri) for {hierarchy['state_name']}")
