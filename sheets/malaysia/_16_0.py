...
# ==========================================
# MAPPING CONFIGURATION FOR JADUAL 16.0 (NEGERI)
# ==========================================
...
def populate_jadual_16_0(sheet, hierarchy):
    print(f"  -> Populating Jadual 16.0 (Penduduk Negeri) for {hierarchy['state_name']}")
