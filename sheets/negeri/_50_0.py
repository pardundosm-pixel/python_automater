...
def populate_jadual_50_0(sheet, hierarchy, report_type):
    ...
    # 1. Title Generation
    title_bm_base = f": Jenayah kekerasan mengikut daerah PDRM dan jenis jenayah, {state_name}, 2023 - 2025"
    title_en_base = f": Assault crime by PDRM district and type of crime, {state_name}, 2023 - 2025"
