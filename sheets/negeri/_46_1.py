...
def populate_jadual_46_1(sheet, hierarchy, report_type):
    ...
    print(f"  -> Populating Jadual 46.1 (AUP) untuk {state_name}")
    ...
    # ==========================================
    title_bm = f": Harga purata item terpilih, {state_name}, 2023 - 2025"
    title_en = f": Average price for selected items, {state_name}, 2023 - 2025"
