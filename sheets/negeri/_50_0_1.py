...
def populate_jadual_50_0_1(sheet, hierarchy, report_type):
    ...
    for coords in TITLE_COORDINATES:
        ...
        safe_write(sheet, coords["bm_prefix"][0], coords["bm_prefix"][1], title_bm_prefix)
        safe_write(sheet, coords["bm_suffix"][0], coords["bm_suffix"][1], title_bm_suffix_base + suffix_bm)
